...
\vspace{-1em}
\textbf{\emph{Master of Science in Computer Engineering}} \hfill \textit{Expected May 2018}\\
...
%\rule{7.1in}{0.5pt}\\
\textbf{\emph{Bachelor of Arts in East Asian Studies with Japanese Language Concentration}} \hfill \textit{Expected December 2017}\\
%\textit{The University of Kansas, Lawrence, Kansas}\\
%\rule{7.1in}{0.5pt}\\
\end{adjustwidth}
\begin{adjustwidth}{0.2in}{0in}
...
\begin{adjustwidth}{0.2in}{0in}
\vspace{-1em}
\textbf{Cox Automotive, Mission, Kansas} \hfill \textit{Software Engineering Intern, Summer 2017-Present}\\
$\circ$ Utilized ReactJS to develop a new reusable feature for organizing customer leads for clients\\
$\circ$ Worked in a SCRUM team to iteratively develop product\\
\rule{7.3in}{0.5pt}\\
\textbf{University of Kansas} \hfill \textit{Graduate Teaching Assistant for EECS 541 (Senior Design), Fall 2016-Present}\\
$\circ$ Design and teach labs that prepare students to propose and implement senior design projects\\
$\circ$ Assist seniors majoring in computer engineering with completing capstone projects\\
\rule{7.3in}{0.5pt}\\
...
\vspace{-1em}
\textbf{Computer}\\
$\circ$ C++, C, CUDA, JavaScript, Python, Haskell, C\#, Java, SQL Server, Scheme(Racket), and Matlab Programming\\
